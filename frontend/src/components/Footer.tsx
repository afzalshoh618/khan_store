        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 py-10">
          <div className="space-y-3">
            ...
            <p className="text-xs text-text-muted leading-relaxed">
              {t(
                "Khan Store Premium — Original, Lux Copy va Super Klon 1:1 Shveytsariya hamda brend soatlari do'koni. Samarqanddan butun dunyo bo'ylab yetkazish.",
            ...
            <ul className="space-y-2 text-xs font-medium">
              ...
              <li>
                <Link href="/shop?quality_tier=lux_copy" className="hover:text-text-main transition-colors">
                  {t("Lux Copy Soatlar", "Часы Lux Копия")}
                </Link>
              </li>
              <li>
