      ...
      <section className="bg-bg-subtle border-b border-border-main py-10 sm:py-14">
        <div className="max-w-4xl mx-auto px-4 space-y-4">
          ...
          <p className="text-text-muted text-sm sm:text-base max-w-2xl mx-auto font-normal leading-relaxed">
            {t(
              `${STORE_CONTACTS.storeName} — Original, Lux Copy va Super Klon 1:1 Shveytsariya hamda brend soatlari do'koni. Biz Samarqand shahridagi Atlas savdo markazida va butun dunyo bo'ylab xizmat ko'rsatamiz.`,
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
        ...
        <section className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="p-6 rounded-2xl bg-bg-card border border-border-main space-y-3 shadow-sm">
            ...
            <p className="text-xs text-text-muted leading-relaxed">
              {t(
                "Original, Lux Copy va Super Klon 1:1 — har bir xaridor didi va hamyoniga mos mukammal soatlar.",
